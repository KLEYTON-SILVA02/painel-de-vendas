...
// Capelo de formatura (função Tutoriais) — mesmo símbolo do sistema antigo,
// hand-authored no mesmo estilo Feather/Lucide (24x24, stroke) dos demais.
...
// Área de Suporte (troca de senha, transferência de administração).
